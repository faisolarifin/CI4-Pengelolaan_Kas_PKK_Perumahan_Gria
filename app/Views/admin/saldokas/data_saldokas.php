...
<!--                  <h6 class="card-subtitle">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Iure, voluptatibus..</h6>-->
               ...
               <div class="col-sm-3 text-right">
                   <a href="/saldokas/tambah"><button class="btn btn-primary custom-radius custom-shadow"> <i data-feather="plus-circle" class="svg-icon"></i> Tambah</button></a>
               </div>
           </div>
                  ...
                  ?>
                    <tr>
                        ...
                        <td class="text-center">
                            <form action="<?= base_url("saldokas/{$row['id_saldo']}") ?>" method="post" class="d-inline">
                                <input type="hidden" name="_method" value="DELETE">
                                <button class="btn btn-sm btn-danger"> <i data-feather="delete" class="svg-icon"></i> </button>
                            </form>
                            <a href="<?= base_url("saldokas/{$row['id_saldo']}/edit") ?>"><button class="btn btn-sm btn-primary my-1"> <i data-feather="edit" class="svg-icon"></i> </button></a>
                        </td>
                    </tr>
                <?php
                endforeach;
