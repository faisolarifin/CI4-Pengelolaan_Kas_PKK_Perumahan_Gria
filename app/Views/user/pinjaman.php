...
<!--                  <h6 class="card-subtitle">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Iure, voluptatibus..</h6>-->
               ...
               <div class="col-sm-3 text-right">
                   <a href="/pinjam"><button class="btn btn-primary custom-radius custom-shadow"> <i data-feather="plus-circle" class="svg-icon"></i> Pinjam</button></a>
               </div>
           </div>
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <?php
                              if ($row['status'] == 'pending') :
                            ?>
                            <form action="<?= base_url("pinjaman/{$row['id_pinjam']}/batal") ?>" method="post" class="d-inline">
